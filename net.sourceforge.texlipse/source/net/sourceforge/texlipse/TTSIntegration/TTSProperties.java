...
public class TTSProperties {  
	...
	public static final String SEND_DATA_CHK_CAPSLOCK="**(checkCapsLock)**";
	
	public static final String MSG_WARNING_ACESBLTY_FORM_LABELS = "Missing labels are not recommended as per PDF accessibility standards";
	public static final String MSG_WARNING_ACESBLTY_FORM_HIDDEN_FIELDS = "Hidden fields are not recommended as per PDF accessibility standards";
	...
	public static final String MSG_WARNING_ACESBLTY_COMENTS = "Comments are not recommended as per PDF accessibility standards";
	...
	public static final String MSG_WARNING_ACESSIBILITY_Package = "Missing accessibility package, please include that to create a tagged PDF";
